...
$states = [
    ...
    'Alaska' => [
        ...
        'Northwest Arctic Borough', 'Petersburg Borough', 'Prince of Wales-Hyder Census Area',
        'Sitka City and Borough', 'Skagway Municipality', 'Southeast Fairbanks Census Area',
        'Valdez-Cordova Census Area', 'Wrangell City and Borough', 'Yakutat City and Borough',
    ...
    'Minnesota' => [
        ...
        'Renville', 'Rice', 'Rock', 'Roseau', 'St. Louis',
    ...
    'Missouri' => [
        ...
        'Ste. Genevieve', 'Saline', 'Schuyler', 'Scotland', 'Scott',
    ...
    'Montana' => [
        ...
        'Liberty', 'Lincoln', 'McCone', 'Madison', 'Meagher',
    ...
    'Nebraska' => [
        ...
        'Keith', 'Keya Paha', 'Kimball', 'Knox', 'Lancaster',
    ...
    'South Dakota' => [
        ...
        'Lincoln', 'Lyman', 'McCook', 'McPherson', 'Marshall',
    ...
    'Texas' => [
        ...
        'Calhoun', 'Callahan', 'Cameron', 'Camp', 'Carson', 'Cass',
        ...
        'Crockett', 'Crosby', 'Culberson', 'Dallam', 'Dallas', 'Dawson',
        'Deaf Smith', 'Delta', 'Denton', 'DeWitt', 'Dickens', 'Dimmit',
        ...
        'Knox', 'Lamar', 'Lamb', 'Lampasas', 'La Salle', 'Lavaca',
        ...
        'Robertson', 'Rockwall', 'Runnels', 'Rusk', 'Sabine', 'San Augustine',
        'San Jacinto', 'San Patricio', 'San Saba', 'Schleicher', 'Scurry',
